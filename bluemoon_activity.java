 ...
 */
public class bluemoon_activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bluemoon_layout);
        ...
        medusa = (ImageView) findViewById(R.id.medusa);
        ...
        if (char_application.swordStatus == 0) {
            ...
            char_application.lifeboss9 = 48000;
        }
        ...
        if (char_application.parametro9 == 10000) {
            medusa.setImageResource(android.R.color.transparent);
            medusa.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                        ...
                        public void run() {
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    if (char_application.parametro9 != 10000 && paremeter == 0) {

                                        medusa.setBackgroundResource(R.drawable.bossmedusa_damage);
                                    } else if (char_application.parametro9 != 10000 && paremeter == 1) {
                                        medusa.setBackgroundResource(R.drawable.bossmedusa_damage);
                                    }
                                    mHandler.postDelayed(new Runnable() {
                                        public void run() {
                                            ...
                                            if (char_application.swordStatus == 0) {
                                                char_application.lifeboss9 = char_application.lifeboss9 - 500;

                                            } else if (char_application.swordStatus == 1) {

                                                char_application.lifeboss9 = char_application.lifeboss9 - 1000;

                                            } else if (char_application.swordStatus == 2) {

                                                char_application.lifeboss9 = char_application.lifeboss9 - 2000;

                                            } else if (char_application.swordStatus == 3) {

                                                char_application.lifeboss9 = char_application.lifeboss9 - 4000;

                                            } else if (char_application.swordStatus == 4) {

                                                char_application.lifeboss9 = char_application.lifeboss9 - 6000;

                                            } else if (char_application.swordStatus == 5) {

                                                char_application.lifeboss9 = char_application.lifeboss9 - 11000;

                                            } else if (char_application.swordStatus == 6) {

                                                char_application.lifeboss9 = char_application.lifeboss9 - 18000;

                                            } else if (char_application.swordStatus == 7) {

                                                char_application.lifeboss9 = char_application.lifeboss9 - 100000;

                                            } else if (char_application.swordStatus == 8) {

                                                char_application.lifeboss9 = char_application.lifeboss9 - 13000;

                                            }

                                            if (char_application.lifeboss9 < 0) {

                                                char_application.lifeboss9 = 0;
                                            }
                                            ...
                                            if (char_application.lifeboss9 == 0) {
                                                ...
                                                medusa.setImageResource(android.R.color.transparent);
                                                medusa.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                                char_application.parametro9 = 10000;
                                                mHandler.postDelayed(new Runnable() {
                                                    public void run() {
                                                        char_application.nivel = 8;
                                            ...
                                            } else if (char_application.lifeboss9 > 0 && paremeter == 0) {

                                                medusa.setBackgroundResource(R.drawable.bossmedusa_default);

                                            } else if (char_application.lifeboss9 > 0 && paremeter == 1) {
            ...
            public void run() {
                ...
                mHandler.postDelayed(new Runnable() {
                    public void run() {
                        ...
                        veryjump.setTag(android.R.color.holo_orange_light);
                        atkfinalboss2.setBackgroundResource(R.drawable.blue_orb_power);
                        mHandler.postDelayed(new Runnable() {
                            public void run() {
                                ...
                                funilboss.setBackgroundResource(R.drawable.blue_orb_power);

                                if (run2.getTag().equals(android.R.color.darker_gray)) {

                                    run2boss.setBackgroundResource(R.drawable.blue_orb_power);
                                    Toast.makeText(bluemoon_activity.this,
                                        ...
                                        mHandler.postDelayed(new Runnable() {
                                            public void run() {
                                                ...
                                                if (veryjump.getTag().equals(android.R.color.holo_orange_dark)) {
                                                    jump.setBackgroundResource(R.drawable.blue_orb_power);

                                                } else if (veryjump.getTag().equals(android.R.color.holo_orange_light)) {
                                                    run1boss.setBackgroundResource(R.drawable.blue_orb_power);
                                                    Toast.makeText(bluemoon_activity.this,
                                                            "Voce morreu!", Toast.LENGTH_SHORT).show();
                                                    goDie();
                                                    char_application.dinheiroConta = 0;
                                                ...
                                                mHandler.postDelayed(new Runnable() {
                                                    public void run() {
                                                        ...
                                                        atkfinalboss.setBackgroundResource(R.drawable.blue_orb_power);
                                                        mHandler.postDelayed(new Runnable() {
                                                            public void run() {
    ...
    public void startCall(View view) {
        Intent intent = new Intent(bluemoon_activity.this, char_status.class);
    ...
    public void nextLevel(View view) {
        this.finish();
        if (char_application.parametro9 == 10000) {
            Intent intent = new Intent(bluemoon_activity.this, greenmoon_activity.class);
            startActivity(intent);

        } else if (char_application.parametro9 != 10000) {
            Toast.makeText(bluemoon_activity.this,
    ...
    public void goTown(View view) {
        ...
        this.finish();
        if (char_application.parametro9 == 10000) {
            Intent intent = new Intent(bluemoon_activity.this, moon_activity.class);
            startActivity(intent);
    ...
    public void goDie() {
        ...
        this.finish();
        Intent intent = new Intent(bluemoon_activity.this, townActivity.class);
        startActivity(intent);
