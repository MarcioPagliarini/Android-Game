...
public class city_activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grievous = (ImageView) findViewById(R.id.grievous);
        ...
        if (char_application.parametro7 == 10000) {
            grievous.setImageResource(android.R.color.transparent);
            grievous.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                        ...
                        public void run() {
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    if (char_application.parametro7 != 10000 && paremeter == 0) {

                                        grievous.setBackgroundResource(R.drawable.bossgrievous_damage);
                                    } else if (char_application.parametro7 != 10000 && paremeter == 1) {
                                        grievous.setBackgroundResource(R.drawable.bossgrievous_damage2);
                                    }
                                    mHandler.postDelayed(new Runnable() {
                                        public void run() {
                                            ...
                                            if (char_application.swordStatus == 0) {
                                                char_application.lifeboss7 = char_application.lifeboss7 - 500;

                                            } else if (char_application.swordStatus == 1) {

                                                char_application.lifeboss7 = char_application.lifeboss7 - 1000;

                                            } else if (char_application.swordStatus == 2) {

                                                char_application.lifeboss7 = char_application.lifeboss7 - 2000;

                                            } else if (char_application.swordStatus == 3) {

                                                char_application.lifeboss7 = char_application.lifeboss7 - 4000;

                                            } else if (char_application.swordStatus == 4) {

                                                char_application.lifeboss7 = char_application.lifeboss7 - 6000;

                                            } else if (char_application.swordStatus == 5) {

                                                char_application.lifeboss7 = char_application.lifeboss7 - 11000;

                                            } else if (char_application.swordStatus == 6) {

                                                char_application.lifeboss7 = char_application.lifeboss7 - 18000;

                                            } else if (char_application.swordStatus == 7) {

                                                char_application.lifeboss7 = char_application.lifeboss7 - 100000;

                                            } else if (char_application.swordStatus == 8) {

                                                char_application.lifeboss7 = char_application.lifeboss7 - 13000;

                                            }

                                            if (char_application.lifeboss7 < 0) {

                                                char_application.lifeboss7 = 0;
                                            }
                                            ...
                                            if (char_application.lifeboss7 == 0) {
                                                ...
                                                grievous.setImageResource(android.R.color.transparent);
                                                grievous.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                                char_application.parametro7 = 10000;
                                                mHandler.postDelayed(new Runnable() {
                                                    public void run() {
                                                        char_application.nivel = 7;
                                            ...
                                            } else if (char_application.lifeboss7 > 0 && paremeter == 0) {

                                                grievous.setBackgroundResource(R.drawable.bossgrievous_default);

                                            } else if (char_application.lifeboss7 > 0 && paremeter == 1) {

                                                grievous.setBackgroundResource(R.drawable.bossgrievous_default2);
    ...
    public void bossAtack() {
        ...
        if (char_application.lifeboss7 > 33000) {
                ...
                public void run() {
                    ...
                    mHandler.postDelayed(new Runnable() {
                        public void run() {
                            ...
                            veryjump.setTag(android.R.color.holo_orange_light);
                            atkfinalboss2.setBackgroundResource(R.drawable.bossgrievous_atk);
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    funilboss.setBackgroundResource(R.drawable.bossgrievous_atk);

                                    if (run2.getTag().equals(android.R.color.darker_gray)) {

                                        run2boss.setBackgroundResource(R.drawable.bossgrievous_atk);
                                        Toast.makeText(city_activity.this,
                                            ...
                                            mHandler.postDelayed(new Runnable() {
                                                public void run() {
                                                    ...
                                                    if (veryjump.getTag().equals(android.R.color.holo_orange_dark)) {
                                                        jump.setBackgroundResource(R.drawable.bossgrievous_atk);

                                                    } else if (veryjump.getTag().equals(android.R.color.holo_orange_light)) {
                                                        run1boss.setBackgroundResource(R.drawable.bossgrievous_atk);
                                                        Toast.makeText(city_activity.this,
                                                                "Voce morreu!", Toast.LENGTH_SHORT).show();
                                                        goDie();
                                                        char_application.dinheiroConta = 0;
                                                    ...
                                                    mHandler.postDelayed(new Runnable() {
                                                        public void run() {
                                                            ...
                                                            atkfinalboss.setBackgroundResource(R.drawable.bossgrievous_atk);
                                                            mHandler.postDelayed(new Runnable() {
                                                                public void run() {
        ...
        } else if (char_application.lifeboss7 <= 33000) {
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    if (run2.getTag().equals(android.R.color.darker_gray)) {
                                        ...
                                        forward.setImageResource(android.R.color.transparent);
                                        forward.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                        grievous.setBackgroundResource(R.drawable.bossgrievous_atk);
    ...
    public void startCall(View view) {
        Intent intent = new Intent(city_activity.this, char_status.class);
    ...
    public void nextLevel(View view) {
        this.finish();
        if (char_application.parametro7 == 10000) {
            Intent intent = new Intent(city_activity.this, moon_activity.class);
            startActivity(intent);

        } else if (char_application.parametro7 != 10000) {
            Toast.makeText(city_activity.this,
    ...
    public void goTown(View view) {
        ...
        this.finish();
        if (char_application.parametro7 == 10000) {
            Intent intent = new Intent(city_activity.this, grass_activity.class);
            startActivity(intent);
    ...
    public void goDie() {
        ...
        this.finish();
        Intent intent = new Intent(city_activity.this, townActivity.class);
        startActivity(intent);
