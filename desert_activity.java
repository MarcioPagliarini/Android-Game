 ...
 */
public class desert_activity extends Activity {
    ImageView jump;
    ImageView sword;
    ImageView run1;
    ImageView run2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desert_layout);
        ...
        if (char_application.parametro5 == 10000) {

            tree.setBackgroundResource(R.drawable.bosstree_dead);

            forward.setBackgroundResource(R.drawable.flecha_right);
            backward.setBackgroundResource(R.drawable.flecha_left);
        }else if(char_application.parametro5 == 0){

            tree.setBackgroundResource(R.drawable.bosstree_default);
                        ...
                        public void run() {
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    funil.setImageResource(android.R.color.transparent);
                                    funil.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                    if(char_application.lifeboss5 <= 0){
                                        tree.setBackgroundResource(R.drawable.bosstree_dead);
                                    }else if(char_application.lifeboss5 > 0){
                                        tree.setImageResource(android.R.color.transparent);
                                        tree.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                    }
                                    ...
                                    if (char_application.parametro5 != 10000) {
                                        ...
                                        tree.setBackgroundResource(R.drawable.bosstree_damage);
                                    }
                                    mHandler.postDelayed(new Runnable() {
                                        public void run() {
                                            ...
                                            if (char_application.swordStatus == 0) {
                                                char_application.lifeboss5 = char_application.lifeboss5 - 500;

                                            } else if (char_application.swordStatus == 1) {

                                                char_application.lifeboss5 = char_application.lifeboss5 - 1000;

                                            } else if (char_application.swordStatus == 2) {

                                                char_application.lifeboss5 = char_application.lifeboss5 - 2000;

                                            } else if (char_application.swordStatus == 3) {

                                                char_application.lifeboss5 = char_application.lifeboss5 - 4000;

                                            } else if (char_application.swordStatus == 4) {

                                                char_application.lifeboss5 = char_application.lifeboss5 - 6000;

                                            } else if (char_application.swordStatus == 5) {

                                                char_application.lifeboss5 = char_application.lifeboss5 - 11000;

                                            } else if (char_application.swordStatus == 6) {

                                                char_application.lifeboss5 = char_application.lifeboss5 - 18000;

                                            } else if (char_application.swordStatus == 7) {

                                                char_application.lifeboss5 = char_application.lifeboss5 - 100000;

                                            } else if (char_application.swordStatus == 8) {

                                                char_application.lifeboss5 = char_application.lifeboss5 - 13000;

                                            }

                                            if (char_application.lifeboss5 < 0) {

                                                char_application.lifeboss5 = 0;
                                                tree.setBackgroundResource(R.drawable.bosstree_dead);
                                            }

                                            if (char_application.lifeboss5 == 0) {

                                                char_application.parametro5 = 10000;
                                                mHandler.postDelayed(new Runnable() {
                                                    public void run() {
                                                        char_application.nivel = 5;
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    if (run2.getTag().equals(android.R.color.darker_gray)) {
                                        ...
                                        Toast.makeText(desert_activity.this,
    ...
    public void startCall(View view) {
        Intent intent = new Intent(desert_activity.this, char_status.class);
    ...
    public void nextLevel(View view) {
        this.finish();
        if (char_application.parametro5 == 10000) {
            Intent intent = new Intent(desert_activity.this, grass_activity.class);
            startActivity(intent);

        } else if (char_application.parametro5 != 10000) {
            Toast.makeText(desert_activity.this,
    ...
    public void goTown(View view) {
        ...
        this.finish();
        if (char_application.parametro5 == 10000) {
            Intent intent = new Intent(desert_activity.this, witch_activity.class);
            startActivity(intent);
    ...
    public void goDie() {
        ...
        this.finish();
        Intent intent = new Intent(desert_activity.this, townActivity.class);
        startActivity(intent);
