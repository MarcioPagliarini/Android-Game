...
/**
 * Created by Marcio Labin on 18/12/2015.
 */
public class grass_activity extends Activity {
    ImageView jump;
    ImageView sword;
    ImageView run1;
    ImageView run2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(char_application.swordStatus == 0){
            ...
            char_application.lifeboss6 = 24000;
        }
        ...
        if (char_application.parametro6 == 10000) {
            animals.setImageResource(android.R.color.transparent);
            animals.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                        ...
                        public void run() {
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    if (char_application.parametro6 != 10000 && parameter == 0) {

                                        animals.setBackgroundResource(R.drawable.bossspider_damage);
                                    }else if (char_application.parametro6 != 10000 && parameter == 1){

                                        animals.setBackgroundResource(R.drawable.bossbat_damage);
                                    }else if (char_application.parametro6 != 10000 && parameter == 2){

                                        animals.setBackgroundResource(R.drawable.bossgaruda_damage);
                                    }
                                    mHandler.postDelayed(new Runnable() {
                                        public void run() {
                                            ...
                                            if (char_application.swordStatus == 0) {
                                                char_application.parametro6 = char_application.lifeboss6 - 500;

                                            } else if (char_application.swordStatus == 1) {

                                                char_application.lifeboss6 = char_application.lifeboss6 - 1000;

                                            } else if (char_application.swordStatus == 2) {

                                                char_application.lifeboss6 = char_application.lifeboss6 - 2000;

                                            } else if (char_application.swordStatus == 3) {

                                                char_application.lifeboss6 = char_application.lifeboss6 - 4000;

                                            } else if (char_application.swordStatus == 4) {

                                                char_application.lifeboss6 = char_application.lifeboss6 - 6000;

                                            } else if (char_application.swordStatus == 5) {

                                                char_application.lifeboss6 = char_application.lifeboss6 - 11000;

                                            } else if (char_application.swordStatus == 6) {

                                                char_application.lifeboss6 = char_application.lifeboss6 - 18000;

                                            } else if (char_application.swordStatus == 7) {

                                                char_application.lifeboss6 = char_application.lifeboss6 - 100000;

                                            } else if (char_application.swordStatus == 8) {

                                                char_application.lifeboss6 = char_application.lifeboss6 - 13000;

                                            }

                                            if (char_application.lifeboss6 < 0) {

                                                char_application.lifeboss6 = 0;
                                            }
                                            ...
                                            if (char_application.lifeboss6 == 0) {
                                                ...
                                                animals.setImageResource(android.R.color.transparent);
                                                animals.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                                char_application.parametro6 = 10000;
                                                mHandler.postDelayed(new Runnable() {
                                                    public void run() {
                                                        char_application.nivel = 6;
                                            ...
                                            } else if (char_application.lifeboss6 > 0) {

                                                if ( parameter == 0) {

                                                    animals.setBackgroundResource(R.drawable.bosspider_default);
                                                }else if (parameter == 1){

                                                    animals.setBackgroundResource(R.drawable.bossbat_default);
                                                }else if (parameter == 2){

                                                    animals.setBackgroundResource(R.drawable.bossgaruda_default);
                                                }
                ...
                public void run() {
                    ...
                    mHandler.postDelayed(new Runnable() {
                        public void run() {
                            ...
                            if (char_application.swordStatus == 0) {
                                char_application.lifeboss6 = char_application.lifeboss6 - 500;
    ...
    public void bossAtack() {
        ...
        if(char_application.lifeboss6 > 36000) {
            mHandler.postDelayed(new Runnable() {
                public void run() {
                    animals.setImageResource(android.R.color.transparent);
                    animals.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    if (run2.getTag().equals(android.R.color.darker_gray)) {
                                        ...
                                        Toast.makeText(grass_activity.this,
        ...
        }else if(char_application.lifeboss6 > 18000 && char_application.lifeboss6 <= 36000){
            parameter = 1;
            mHandler.postDelayed(new Runnable() {
                public void run() {
                    animals.setImageResource(android.R.color.transparent);
        ...
        }else if(char_application.lifeboss6 <= 18000){
            parameter = 2;
            mHandler.postDelayed(new Runnable() {
                public void run() {
                    animals.setImageResource(android.R.color.transparent);
    ...
    public void startCall(View view) {
        Intent intent = new Intent(grass_activity.this, char_status.class);
    ...
    public void nextLevel(View view) {
        ...
        this.finish();
        if (char_application.parametro6 == 10000) {
            Intent intent = new Intent(grass_activity.this, city_activity.class);
            startActivity(intent);

        } else if (char_application.parametro6 != 10000) {
            Toast.makeText(grass_activity.this,
    ...
    public void goTown(View view) {
        ...
        this.finish();
        if (char_application.parametro6 == 10000) {
            Intent intent = new Intent(grass_activity.this, desert_activity.class);
            startActivity(intent);
    ...
    public void goDie() {
        ...
        this.finish();
        Intent intent = new Intent(grass_activity.this, townActivity.class);
        startActivity(intent);
