 ...
 */
public class greenmoon_activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.greenmoon_layout);
        ...
        medusa2 = (ImageView) findViewById(R.id.medusa2);
        ...
        if (char_application.parametro10 == 10000) {
            medusa2.setImageResource(android.R.color.transparent);
            medusa2.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                        ...
                        public void run() {
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    if (char_application.parametro10 != 10000 && paremeter == 0) {

                                        medusa2.setBackgroundResource(R.drawable.bossmedusa2_damage);
                                    } else if (char_application.parametro10 != 10000 && paremeter == 1) {
                                        medusa2.setBackgroundResource(R.drawable.bossmedusa2_damage);
                                    }
                                    mHandler.postDelayed(new Runnable() {
                                        public void run() {
                                            ...
                                            if (char_application.swordStatus == 0) {
                                                char_application.lifeboss10 = char_application.lifeboss10 - 500;

                                            } else if (char_application.swordStatus == 1) {

                                                char_application.lifeboss10 = char_application.lifeboss10 - 1000;

                                            } else if (char_application.swordStatus == 2) {

                                                char_application.lifeboss10 = char_application.lifeboss10 - 2000;

                                            } else if (char_application.swordStatus == 3) {

                                                char_application.lifeboss10 = char_application.lifeboss10 - 4000;

                                            } else if (char_application.swordStatus == 4) {

                                                char_application.lifeboss10 = char_application.lifeboss10 - 6000;

                                            } else if (char_application.swordStatus == 5) {

                                                char_application.lifeboss10 = char_application.lifeboss10 - 11000;

                                            } else if (char_application.swordStatus == 6) {

                                                char_application.lifeboss10 = char_application.lifeboss10 - 18000;

                                            } else if (char_application.swordStatus == 7) {

                                                char_application.lifeboss10 = char_application.lifeboss10 - 100000;

                                            } else if (char_application.swordStatus == 8) {

                                                char_application.lifeboss10 = char_application.lifeboss10 - 13000;

                                            }

                                            if (char_application.lifeboss10 < 0) {

                                                char_application.lifeboss10 = 0;
                                            }
                                            ...
                                            if (char_application.lifeboss10 == 0) {
                                                ...
                                                medusa2.setImageResource(android.R.color.transparent);
                                                medusa2.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                                char_application.parametro10 = 10000;
                                                mHandler.postDelayed(new Runnable() {
                                                    public void run() {
                                            ...
                                            } else if (char_application.lifeboss10 > 0 && paremeter == 0) {

                                                medusa2.setBackgroundResource(R.drawable.bossmedusa2_default);

                                            } else if (char_application.lifeboss10 > 0 && paremeter == 1) {
    ...
    public void bossAtack() {
        ...
        mHandler.postDelayed(new Runnable() {
            public void run() {
                medusa2.setImageResource(android.R.color.transparent);
                medusa2.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                medusa2.setBackgroundResource(R.drawable.bossmedusa2_atk);
                mHandler.postDelayed(new Runnable() {
                    public void run() {
                        if (char_application.parametro10 != 10000) {
                            medusa2.setBackgroundResource(R.drawable.bossmedusa2_default);
                        ...
                        mHandler.postDelayed(new Runnable() {
                            public void run() {
                                ...
                                if (run2.getTag().equals(android.R.color.darker_gray)) {
                                    ...
                                    Toast.makeText(greenmoon_activity.this,
    ...
    public void startCall(View view) {
        Intent intent = new Intent(greenmoon_activity.this, char_status.class);
    ...
    public void nextLevel(View view) {
        this.finish();
        if (char_application.parametro10 == 10000) {
            Intent intent = new Intent(greenmoon_activity.this, heaven_activity.class);
            startActivity(intent);
    ...
    public void goTown(View view) {
        ...
        this.finish();
        if (char_application.parametro10 == 10000) {
            Intent intent = new Intent(greenmoon_activity.this, bluemoon_activity.class);
            startActivity(intent);
    ...
    public void goDie() {
        ...
        this.finish();
        Intent intent = new Intent(greenmoon_activity.this, townActivity.class);
        startActivity(intent);
