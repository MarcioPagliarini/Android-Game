 ...
 */
public class moon_activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lacaio = (ImageView) findViewById(R.id.lacaio);
        ...
        if (char_application.swordStatus == 0) {
            ...
            char_application.lifeboss8 = 36000;
        }
        ...
        if (char_application.parametro8 == 10000) {
            lacaio.setImageResource(android.R.color.transparent);
            lacaio.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                        ...
                        public void run() {
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    if (char_application.parametro8 != 10000 && paremeter == 0) {

                                        lacaio.setBackgroundResource(R.drawable.bosslacaio_damage);
                                    } else if (char_application.parametro8 != 10000 && paremeter == 1) {
                                        lacaio.setBackgroundResource(R.drawable.bosslacaio_damage);
                                    }
                                    mHandler.postDelayed(new Runnable() {
                                        public void run() {
                                            ...
                                            if (char_application.swordStatus == 0) {
                                                char_application.lifeboss8 = char_application.lifeboss8 - 500;

                                            } else if (char_application.swordStatus == 1) {

                                                char_application.lifeboss8 = char_application.lifeboss8 - 1000;

                                            } else if (char_application.swordStatus == 2) {

                                                char_application.lifeboss8 = char_application.lifeboss8 - 2000;

                                            } else if (char_application.swordStatus == 3) {

                                                char_application.lifeboss8 = char_application.lifeboss8 - 4000;

                                            } else if (char_application.swordStatus == 4) {

                                                char_application.lifeboss8 = char_application.lifeboss8 - 6000;

                                            } else if (char_application.swordStatus == 5) {

                                                char_application.lifeboss8 = char_application.lifeboss8 - 11000;

                                            } else if (char_application.swordStatus == 6) {

                                                char_application.lifeboss8 = char_application.lifeboss8 - 18000;

                                            } else if (char_application.swordStatus == 7) {

                                                char_application.lifeboss8 = char_application.lifeboss8 - 100000;

                                            } else if (char_application.swordStatus == 8) {

                                                char_application.lifeboss8 = char_application.lifeboss8 - 13000;

                                            }

                                            if (char_application.lifeboss8 < 0) {

                                                char_application.lifeboss8 = 0;
                                            }
                                            ...
                                            if (char_application.lifeboss8 == 0) {
                                                ...
                                                lacaio.setImageResource(android.R.color.transparent);
                                                lacaio.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                                char_application.parametro8 = 10000;
                                                mHandler.postDelayed(new Runnable() {
                                                    public void run() {
                                            ...
                                            } else if (char_application.lifeboss8 > 0 && paremeter == 0) {

                                                lacaio.setBackgroundResource(R.drawable.bosslacaio_default);

                                            } else if (char_application.lifeboss8 > 0 && paremeter == 1) {
                        ...
                        mHandler.postDelayed(new Runnable() {
                            public void run() {
                                ...
                                if (run2.getTag().equals(android.R.color.darker_gray)) {
                                    ...
                                    Toast.makeText(moon_activity.this,
    ...
    public void startCall(View view) {
        Intent intent = new Intent(moon_activity.this, char_status.class);
    ...
    public void nextLevel(View view) {
        this.finish();
        if (char_application.parametro8 == 10000) {
            Intent intent = new Intent(moon_activity.this, bluemoon_activity.class);
            startActivity(intent);

        } else if (char_application.parametro8 != 10000) {
            Toast.makeText(moon_activity.this,
    ...
    public void goTown(View view) {
        ...
        this.finish();
        if (char_application.parametro8 == 10000) {
            Intent intent = new Intent(moon_activity.this, city_activity.class);
            startActivity(intent);
    ...
    public void goDie() {
        ...
        this.finish();
        Intent intent = new Intent(moon_activity.this, townActivity.class);
        startActivity(intent);
