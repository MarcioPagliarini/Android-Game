 ...
 */
public class pantanoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pantano_activity);
        ...
        fallenpantano = (ImageView) findViewById(R.id.fallenpantano);
        ...
        if (char_application.parametro == 10000) {

            fallenpantano.setImageResource(android.R.color.transparent);
            fallenpantano.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    if (char_application.parametro != 10000) {
                                        ...
                                        fallenpantano.setBackgroundResource(R.drawable.fallen_damage);
                                    }
                                    mHandler.postDelayed(new Runnable() {
                                        public void run() {
                                            ...
                                            if (char_application.swordStatus == 0) {
                                                char_application.lifeboss1 = char_application.lifeboss1 - 500;

                                            } else if (char_application.swordStatus == 1) {

                                                char_application.lifeboss1 = char_application.lifeboss1 - 1000;

                                            } else if (char_application.swordStatus == 2) {

                                                char_application.lifeboss1 = char_application.lifeboss1 - 2000;

                                            } else if (char_application.swordStatus == 3) {

                                                char_application.lifeboss1 = char_application.lifeboss1 - 4000;

                                            } else if (char_application.swordStatus == 4) {

                                                char_application.lifeboss1 = char_application.lifeboss1 - 6000;

                                            } else if (char_application.swordStatus == 5) {

                                                char_application.lifeboss1 = char_application.lifeboss1 - 11000;

                                            } else if (char_application.swordStatus == 6) {

                                                char_application.lifeboss1 = char_application.lifeboss1 - 18000;

                                            } else if (char_application.swordStatus == 7) {

                                                char_application.lifeboss1 = char_application.lifeboss1 - 100000;

                                            } else if (char_application.swordStatus == 8) {

                                                char_application.lifeboss1 = char_application.lifeboss1 - 13000;

                                            }

                                            if (char_application.lifeboss1 < 0) {

                                                char_application.lifeboss1 = 0;
                                            }
                                            /*Toast.makeText(pantanoActivity.this,
                                                    "Conta deletada!" + char_application.dinheiroConta, Toast.LENGTH_SHORT).show();*/
                                            if (char_application.lifeboss1 == 0) {
                                                char_application.parametro = 10000;
                                                fallenpantano.setImageResource(android.R.color.transparent);
                                                fallenpantano.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                                mHandler.postDelayed(new Runnable() {
                                                    public void run() {
                                            ...
                                            } else if (char_application.lifeboss1 > 0) {

                                                fallenpantano.setBackgroundResource(R.drawable.fallen3);
    ...
    public void startCall(View view) {
        Intent intent = new Intent(pantanoActivity.this, char_status.class);
    ...
    public void nextLevel(View view) {
        ...
        if (char_application.parametro == 10000) {
            ...
            Intent intent = new Intent(pantanoActivity.this, roadActivity.class);
            startActivity(intent);
            this.finish();

        } else if (char_application.parametro != 10000) {
            Toast.makeText(pantanoActivity.this,
    ...
    public void goTown(View view) {
        ...
        if (char_application.parametro == 10000) {
            ...
            Intent intent = new Intent(pantanoActivity.this, townActivity.class);
            startActivity(intent);
            this.finish();
