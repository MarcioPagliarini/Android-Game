...
/**
 * Created by Marcio Labin on 10/12/2015.
 */
public class roadActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orcroad = (ImageView) findViewById(R.id.orcroad);
      ...
      //  char_application.nivel = 2;
        ...
        if (char_application.parametro2 == 10000) {
            orcroad.setImageResource(android.R.color.transparent);
            orcroad.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    if (char_application.parametro2 != 10000) {
                                        ...
                                        orcroad.setBackgroundResource(R.drawable.orc_damage);
                                    }
                                    mHandler.postDelayed(new Runnable() {
                                        public void run() {
                                            ...
                                            if (char_application.swordStatus == 0) {
                                                char_application.lifeboss2 = char_application.lifeboss2 - 500;

                                            } else if (char_application.swordStatus == 1) {

                                                char_application.lifeboss2 = char_application.lifeboss2 - 1000;

                                            } else if (char_application.swordStatus == 2) {

                                                char_application.lifeboss2 = char_application.lifeboss2 - 2000;

                                            } else if (char_application.swordStatus == 3) {

                                                char_application.lifeboss2 = char_application.lifeboss2 - 4000;

                                            } else if (char_application.swordStatus == 4) {

                                                char_application.lifeboss2 = char_application.lifeboss2 - 6000;

                                            } else if (char_application.swordStatus == 5) {

                                                char_application.lifeboss2 = char_application.lifeboss2 - 11000;

                                            } else if (char_application.swordStatus == 6) {

                                                char_application.lifeboss2 = char_application.lifeboss2 - 18000;

                                            } else if (char_application.swordStatus == 7) {

                                                char_application.lifeboss2 = char_application.lifeboss2 - 100000;

                                            } else if (char_application.swordStatus == 8) {

                                                char_application.lifeboss2 = char_application.lifeboss2 - 13000;

                                            }

                                            if (char_application.lifeboss2 < 0) {

                                                char_application.lifeboss2 = 0;
                                            }
                                            ...
                                            if (char_application.lifeboss2 == 0) {
                                                ...
                                                orcroad.setImageResource(android.R.color.transparent);
                                                orcroad.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                                char_application.parametro2 = 10000;
                                                mHandler.postDelayed(new Runnable() {
                                                    public void run() {
                                                        char_application.nivel = 2;
                                                        char_application.dinheiroConta = char_application.dinheiroConta + 500;
                                                        orcroad.setImageResource(android.R.color.transparent);
                                                        orcroad.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                                        backward.setBackgroundResource(R.drawable.flecha_left);
                                                        forward.setBackgroundResource(R.drawable.flecha_right);
                                            ...
                                            } else if (char_application.lifeboss2 > 0) {

                                                orcroad.setBackgroundResource(R.drawable.orc_default);
    ...
    public void bossAtack() {
        ...
        mHandler.postDelayed(new Runnable() {
            public void run() {
                orcroad.setImageResource(android.R.color.transparent);
                orcroad.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                orcroad.setBackgroundResource(R.drawable.orc_atk);
                mHandler.postDelayed(new Runnable() {
                    public void run() {
                        if (char_application.parametro2 != 10000) {
                            orcroad.setBackgroundResource(R.drawable.orc_default);
                        ...
                        veryjump.setTag(android.R.color.holo_orange_light);
                        atkfinalboss2.setBackgroundResource(R.drawable.orc_sword);
                        mHandler.postDelayed(new Runnable() {
                            public void run() {
                                ...
                                funilboss.setBackgroundResource(R.drawable.orc_sword);

                                if (run2.getTag().equals(android.R.color.darker_gray)) {

                                    run2boss.setBackgroundResource(R.drawable.orc_sword);
                                        ...
                                        mHandler.postDelayed(new Runnable() {
                                            public void run() {
                                                ...
                                                if (veryjump.getTag().equals(android.R.color.holo_orange_dark)) {
                                                    jump.setBackgroundResource(R.drawable.orc_sword);

                                                } else if (veryjump.getTag().equals(android.R.color.holo_orange_light)) {
                                                    run1boss.setBackgroundResource(R.drawable.orc_sword);
                                                    Toast.makeText(roadActivity.this,
                                                            "Voce morreu!", Toast.LENGTH_SHORT).show();
                                                    goDie();
                                                    char_application.dinheiroConta = 0;
                                                ...
                                                mHandler.postDelayed(new Runnable() {
                                                    public void run() {
                                                        ...
                                                        atkfinalboss.setBackgroundResource(R.drawable.orc_sword);
                                                        mHandler.postDelayed(new Runnable() {
                                                            public void run() {
    ...
    public void startCall(View view) {
        Intent intent = new Intent(roadActivity.this, char_status.class);
    ...
    public void nextLevel(View view) {
        this.finish();
        if (char_application.parametro2 == 10000) {
            Intent intent = new Intent(roadActivity.this, mountains_earth.class);
            startActivity(intent);

        } else if (char_application.parametro2 != 10000) {
            Toast.makeText(roadActivity.this,
    ...
    public void goTown(View view) {
        ...
        this.finish();
        if (char_application.parametro2 == 10000) {
            Intent intent = new Intent(roadActivity.this, pantanoActivity.class);
            startActivity(intent);
    ...
    public void goDie() {
        ...
        this.finish();
        Intent intent = new Intent(roadActivity.this, townActivity.class);
        startActivity(intent);
