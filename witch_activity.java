...
/**
 * Created by Marcio Labin on 17/12/2015.
 */
public class witch_activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.witch_layout);
        ...
        if (char_application.parametro4 == 10000) {
            wizard.setImageResource(android.R.color.transparent);
            wizard.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                        ...
                        public void run() {
                            ...
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    if (char_application.parametro4 != 10000 && paremeter == 0) {

                                        wizard.setBackgroundResource(R.drawable.bossmage_damage);
                                    }else if(char_application.parametro4 != 10000 && paremeter == 1){
                                        wizard.setBackgroundResource(R.drawable.bossmage2_damage);
                                    }
                                    mHandler.postDelayed(new Runnable() {
                                        public void run() {
                                            ...
                                            if (char_application.swordStatus == 0) {
                                                char_application.lifeboss4 = char_application.lifeboss4 - 500;

                                            } else if (char_application.swordStatus == 1) {

                                                char_application.lifeboss4 = char_application.lifeboss4 - 1000;

                                            } else if (char_application.swordStatus == 2) {

                                                char_application.lifeboss4 = char_application.lifeboss4 - 2000;

                                            } else if (char_application.swordStatus == 3) {

                                                char_application.lifeboss4 = char_application.lifeboss4 - 4000;

                                            } else if (char_application.swordStatus == 4) {

                                                char_application.lifeboss4 = char_application.lifeboss4 - 6000;

                                            } else if (char_application.swordStatus == 5) {

                                                char_application.lifeboss4 = char_application.lifeboss4 - 11000;

                                            } else if (char_application.swordStatus == 6) {

                                                char_application.lifeboss4 = char_application.lifeboss4 - 18000;

                                            } else if (char_application.swordStatus == 7) {

                                                char_application.lifeboss4 = char_application.lifeboss4 - 100000;

                                            } else if (char_application.swordStatus == 8) {

                                                char_application.lifeboss4 = char_application.lifeboss4 - 13000;

                                            }

                                            if (char_application.lifeboss4 < 0) {

                                                char_application.lifeboss4 = 0;
                                            }
                                            ...
                                            if (char_application.lifeboss4 == 0) {
                                                ...
                                                wizard.setImageResource(android.R.color.transparent);
                                                wizard.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                                char_application.parametro4 = 10000;
                                                mHandler.postDelayed(new Runnable() {
                                                    public void run() {
                                                        char_application.nivel = 4;
                                            ...
                                            }  else if (char_application.lifeboss4 > 0 && paremeter ==0) {

                                                wizard.setBackgroundResource(R.drawable.bossmage_standup);

                                            }else if (char_application.lifeboss4 > 0 && paremeter == 1){

                                                wizard.setBackgroundResource(R.drawable.bossmage2_standup);
    ...
    public void bossAtack() {
        ...
        if(char_application.lifeboss4 > 6000) {

            mHandler.postDelayed(new Runnable() {
                public void run() {
                    wizard.setImageResource(android.R.color.transparent);
                    wizard.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                    wizard.setBackgroundResource(R.drawable.bossmage_atk);
                    mHandler.postDelayed(new Runnable() {
                        public void run() {
                            if (char_application.parametro4 != 10000) {
                                wizard.setBackgroundResource(R.drawable.bossmage_standup);
                            ...
                            veryjump.setTag(android.R.color.holo_orange_light);
                            atkfinalboss2.setBackgroundResource(R.drawable.bossmage_eletric);
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    funilboss.setBackgroundResource(R.drawable.bossmage_eletric);

                                    if (run2.getTag().equals(android.R.color.darker_gray)) {

                                        run2boss.setBackgroundResource(R.drawable.bossmage_eletric);
                                        Toast.makeText(witch_activity.this,
                                            ...
                                            mHandler.postDelayed(new Runnable() {
                                                public void run() {
                                                    ...
                                                    if (veryjump.getTag().equals(android.R.color.holo_orange_dark)) {
                                                        jump.setBackgroundResource(R.drawable.bossmage_eletric);

                                                    } else if (veryjump.getTag().equals(android.R.color.holo_orange_light)) {
                                                        run1boss.setBackgroundResource(R.drawable.bossmage_eletric);
                                                        Toast.makeText(witch_activity.this,
                                                                "Voce morreu!", Toast.LENGTH_SHORT).show();
                                                        goDie();
                                                        char_application.dinheiroConta = 0;
                                                    ...
                                                    mHandler.postDelayed(new Runnable() {
                                                        public void run() {
                                                            ...
                                                            atkfinalboss.setBackgroundResource(R.drawable.bossmage_eletric);
                                                            mHandler.postDelayed(new Runnable() {
                                                                public void run() {
        ...
        }else if (char_application.lifeboss4 <= 6000) {
            ...
            mHandler.postDelayed(new Runnable() {
                public void run() {
                    wizard.setImageResource(android.R.color.transparent);
                    wizard.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                    wizard.setBackgroundResource(R.drawable.bossmage2_atk);
                    mHandler.postDelayed(new Runnable() {
                        public void run() {
                            if (char_application.parametro4 != 10000) {
                                wizard.setBackgroundResource(R.drawable.bossmage2_standup);
                            ...
                            veryjump.setTag(android.R.color.holo_orange_light);
                            atkfinalboss2.setBackgroundResource(R.drawable.bossmage2_fire);
                            mHandler.postDelayed(new Runnable() {
                                public void run() {
                                    atkfinalboss2.setImageResource(android.R.color.transparent);
                                    atkfinalboss2.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                    funilboss.setBackgroundResource(R.drawable.bossmage2_fire);

                                    if (run2.getTag().equals(android.R.color.darker_gray)) {

                                        run2boss.setBackgroundResource(R.drawable.bossmage2_fire);
                                        Toast.makeText(witch_activity.this,
                                                "Voce morreu!", Toast.LENGTH_SHORT).show();
                                        goDie();
                                        char_application.dinheiroConta = 0;
                                        ...
                                        public void run() {
                                            ...
                                            mHandler.postDelayed(new Runnable() {
                                                public void run() {
                                                    ...
                                                    if (veryjump.getTag().equals(android.R.color.holo_orange_dark)) {
                                                        jump.setBackgroundResource(R.drawable.bossmage2_fire);

                                                    } else if (veryjump.getTag().equals(android.R.color.holo_orange_light)) {
                                                        run1boss.setBackgroundResource(R.drawable.bossmage2_fire);
                                                        Toast.makeText(witch_activity.this,
                                                                "Voce morreu!", Toast.LENGTH_SHORT).show();
                                                        goDie();
                                                        char_application.dinheiroConta = 0;
                                                    ...
                                                    mHandler.postDelayed(new Runnable() {
                                                        public void run() {
                                                            run1boss.setImageResource(android.R.color.transparent);
                                                            run1boss.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                                                            atkfinalboss.setBackgroundResource(R.drawable.bossmage2_fire);
                                                            mHandler.postDelayed(new Runnable() {
                                                                public void run() {
                                                                    atkfinalboss.setImageResource(android.R.color.transparent);
                                                                    atkfinalboss.setBackgroundColor(getResources().getColor(android.R.color.transparent));
    ...
    public void startCall(View view) {
        Intent intent = new Intent(witch_activity.this, char_status.class);
    ...
    public void nextLevel(View view) {
        this.finish();
        if (char_application.parametro4 == 10000) {
            Intent intent = new Intent(witch_activity.this, desert_activity.class);
            startActivity(intent);
        }
    ...
    public void goTown(View view) {
        ...
        this.finish();
        if (char_application.parametro4 == 10000) {
            Intent intent = new Intent(witch_activity.this, mountains_earth.class);
            startActivity(intent);

        } else if (char_application.parametro4 != 10000) {
            Toast.makeText(witch_activity.this,
    ...
    public void goDie() {
        ...
        this.finish();
        Intent intent = new Intent(witch_activity.this, townActivity.class);
        startActivity(intent);
